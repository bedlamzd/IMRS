...
#Scene object main.lua properties (serialized)
...
sim_message_eventcallback_instancepass    =0x10d        # Called once every main.lua application loop pass. auxiliaryData[0] contains event flags of events that happened since last time
